...
begin 
	declare @Luong int
	declare @HsLuong tinyint
	declare @Phucap int
	declare @BHXH int
	declare @BHYT int
	declare @BHTN int
	declare @ThuNhap int
	declare @MucdoCV nvarchar(20)
...
as begin
	select @tongluong = sum(1490000 * HSLuong + iif(MucDoCV like 'A%', 10000000, 
	(iif(MucDoCV like 'B%', 8000000, 5000000))))
...
-------------
declare @tienluong money 
exec p_Cau7 N'KH' ,5, 1995, @tienluong output 
print 'so tien luong cua phong do:'+ convert(nvarchar(20), @tienluong)