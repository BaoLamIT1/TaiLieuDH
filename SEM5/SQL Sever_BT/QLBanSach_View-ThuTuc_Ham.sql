...
SELECT @soLuongNhap = SUM(SLNhap) , @soLuongBan = SUM(SLBan) FROM tChiTietHDB join tSach on tChiTietHDB.MaSach = tSach.MaSach join tChiTietHDN on tSach.MaSach = tChiTietHDN.MaSach
...
select *from tChiTietHDB where sohdb='HDB012'
----------------------Cach Insert duoc nhieu du lieu 1 luc----------------
...
insert into tChiTietHDB(SoHDB,Masach,SLBan) values ('HDB12','S03',10),('HDB12','S04',1),('HDB12','S05',3)
