...
namespace TH1_laisuatguitietkiem
{
    public partial class Form1 : Form
    {
        ...
        private void cmbTGgui_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            if (kt == 1)
            {
               ...
               + " | " + dtpNgayGui.Text + " | " + txtSoTienGui.Text + " | "
                ...
                listNguoiGuis.Add(new NguoiGui(Convert.ToInt32(txtMaKH.Text),
               txtTenKH.Text, txtDiaChi.Text, Convert.ToInt32(txtSoTienGui.Text),
